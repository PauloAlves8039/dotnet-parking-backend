...
namespace Parking.Model.Test.Interfaces.Services
{
    public class DeleteService
    {
        ...
        public async Task DeleteService_DeleteAsync_ShouldRemoveRecordAndReturnRemovedRecord()
        {
        ...
        public async Task DeleteService_DeleteAsync_ShouldReturnNullWhenRecordNotFound()
        {
            var serviceMock = new Mock<IDeleteService>();
