...
namespace Parking.Model.Test.Interfaces.Services
{
    public class DataRetrievalServiceTest
    {
        ...
        public async Task DataRetrievalService_GetAllAsync_ShouldReturnAllRecords()
        {
        ...
        public async Task DataRetrievalService_GetAllAsync_ShouldReturnEmptyListWhenNoRecordsExist()
        {
            var serviceMock = new Mock<IDataRetrievalService<StayDTO>>();
        ...
        public async Task DataRetrievalService_GetByIdAsync_ShouldReturnRecordWhenIdExists()
        {
            var serviceMock = new Mock<IDataRetrievalService<StayDTO>>();
            var stayId = 1;
        ...
        public async Task DataRetrievalService_GetByIdAsync_ShouldReturnNullWhenRecordIdDoesNotExist()
        {
            var serviceMock = new Mock<IDataRetrievalService<StayDTO>>();
